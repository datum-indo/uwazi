...
import ListChartComponent, { mapStateToProps } from '../ListChart.js';
...
describe('ListChart Markdown component', () => {
  ...
  it('should render a placeholder when data is undefined', () => {
    ...
    const component = shallow(<ListChartComponent.WrappedComponent {...props} property="prop2" />);
  ...
  it('should render the data passed by mapStateToProps', () => {
    ...
    const component = shallow(
      <ListChartComponent.WrappedComponent
        {...props}
        property="prop1"
        classname="custom-class" // eslint-disable-line react/no-unknown-property
        context="tContext"
      />
    );
